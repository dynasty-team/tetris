  ...
  return (
    <Box flexDirection="column" alignItems="center">
      <Box>
        ...
        <Text color="magenta" bold>T E T R I S</Text>
        <Text color="cyan" bold>{' ◆'.repeat(3)}</Text>
      </Box>
      <Box marginTop={1}>
      ...
      <Text color="#7f8caa" dimColor>T E R M I N A L   E D I T I O N</Text>
    </Box>
  );
}
...
function MenuFooter(): React.ReactElement {
  return (
    <Box flexDirection="column" alignItems="center" marginTop={1}>
      <Text color="#7f8caa">↑ / ↓  เลือกเมนู   •   ENTER  ยืนยัน</Text>
      <Text color="#626d83" dimColor>W / S ก็ใช้ได้   •   Q  ออกเกม</Text>
    </Box>
  );
}
  ...
  return (
    <Box flexDirection="column" alignItems="center" paddingY={2}>
      ...
      >
        ...
        <Box marginTop={2} width={PANEL_WIDTH - 8} justifyContent="space-between">
          <Text color="#626d83">RANK</Text>
        ...
        >
          <Box alignItems="center">
            <Text color="#ffd84d" bold> #1 </Text>
            <Text color="#8b96ab">  BEST</Text>
          </Box>
          <Text color={data ? '#fff1a8' : '#778198'} bold>
            {data ? data.highScore.toLocaleString() : '—'}
          </Text>
        </Box>
        ...
        {data ? (
          ...
          <Box
            ...
            borderColor="#3c465d"
          >
            <Text color="#9ba5b7">ยังไม่มีสถิติ  •  ลองเล่นสักหนึ่งตา!</Text>
          </Box>
        )}
      ...
      <Box marginTop={1}>
        ...
        <Text color="#626d83">  กลับหน้าหลัก  •  ENTER/SPACE ก็ได้</Text>
      </Box>
    </Box>
  );
}
